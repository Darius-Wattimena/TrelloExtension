...
class DatabaseHelper {
    companion object {
        fun <T : Identifiable> getCollection(
            clazz: Class<T>,
            collections: HashMap<Class<*>, MongoCollection<*>>
        ): MongoCollection<T> {
            return collections[clazz] as MongoCollection<T>
        }

        fun <T : Identifiable> find(
            id: String,
            clazz: Class<T>,
            collections: HashMap<Class<*>, MongoCollection<*>>
        ): T? {
        ...
        fun <T : Identifiable> find(
            ...
            clazz: Class<T>,
            collections: java.util.HashMap<Class<*>, MongoCollection<*>>
        ): T? {
            val collection = getCollection(clazz, collections)
